...
from benjaminhamon_document_manipulation_scripts.generate_information_as_xhtml import create_serializer, generate_information_as_xhtml


logger = logging.getLogger("Main")


class GenerateInformationAsXhtmlCommand(ApplicationCommand):
    ...
    def configure_argument_parser(self, subparsers: argparse._SubParsersAction, **kwargs) -> argparse.ArgumentParser:
        ...
        argument_parser = subparsers.add_parser("generate-information-as-xhtml", help = "generate document information as xhtml")
