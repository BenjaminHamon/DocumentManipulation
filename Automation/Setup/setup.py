...
def main() -> None:
    ...
    with automation_helpers.execute_in_workspace(__file__):
        ...
        python_helpers.install_python_packages(venv_python_executable, [ "Automation/Scripts" ], simulate = arguments.simulate)
        python_helpers.run_python_command([ automation_executable, "--verbosity", arguments.verbosity, "develop" ], simulate = arguments.simulate)
